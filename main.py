...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_MI', type=float, default=10, help='weight for Mutual information loss')
    parser.add_argument('--lambda_con', type=float, default=1, help='weight for') 
    parser.add_argument('--image_size', type=float, default=32, help='Size of images in dataset')
    parser.add_argument('--FE_conv_dim',type=int,default=128,help='start conv dim for FrontEnd')
